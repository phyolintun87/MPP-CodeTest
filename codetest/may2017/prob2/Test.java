...
//		uncomment when your code is ready
		...
		CheckoutRecordEntry[] entries = {
				new CheckoutRecordEntry(books[0], LocalDate.of(2017, 1, 1),LocalDate.of(2017, 3, 1), ItemType.BOOK),//0
				new CheckoutRecordEntry(books[1], LocalDate.of(2016, 1, 15),LocalDate.of(2016, 3, 15), ItemType.BOOK),//1
				new CheckoutRecordEntry(books[2], LocalDate.of(2017, 2, 1),LocalDate.of(2017, 4, 1), ItemType.BOOK),//2
				new CheckoutRecordEntry(books[3], LocalDate.of(2017, 4, 1),LocalDate.of(2017, 6, 1), ItemType.BOOK),//3
				new CheckoutRecordEntry(books[4], LocalDate.of(2017, 1, 21),LocalDate.of(2017, 3, 21), ItemType.BOOK),//4
				new CheckoutRecordEntry(books[0], LocalDate.of(2016, 3, 1),LocalDate.of(2016, 5, 1), ItemType.BOOK),//5
				new CheckoutRecordEntry(books[1], LocalDate.of(2016, 5, 1),LocalDate.of(2016, 7, 1), ItemType.BOOK),//6
				new CheckoutRecordEntry(books[2], LocalDate.of(2015, 10, 1),LocalDate.of(2015, 12, 1), ItemType.BOOK),//7
				new CheckoutRecordEntry(books[0], LocalDate.of(2015, 5, 1),LocalDate.of(2015, 7, 1), ItemType.BOOK),//8
				new CheckoutRecordEntry(books[1], LocalDate.of(2014, 8, 1),LocalDate.of(2014, 9, 1), ItemType.BOOK),//9
				new CheckoutRecordEntry(cds[0], LocalDate.of(2015, 1, 1),LocalDate.of(2015, 3, 1), ItemType.CD), //10
				new CheckoutRecordEntry(cds[3], LocalDate.of(2015, 6, 1),LocalDate.of(2015, 8, 1), ItemType.CD),//11
				new CheckoutRecordEntry(cds[4], LocalDate.of(2015,5, 10),LocalDate.of(2015, 7, 10), ItemType.CD),//12
				new CheckoutRecordEntry(cds[2], LocalDate.of(2015, 1, 1),LocalDate.of(2015, 3, 1), ItemType.CD),//13
				new CheckoutRecordEntry(cds[1], LocalDate.of(2015, 9, 1),LocalDate.of(2015, 11, 1), ItemType.CD),//14*
				new CheckoutRecordEntry(cds[2], LocalDate.of(2016, 1, 1),LocalDate.of(2016, 3, 1), ItemType.CD),//15
				new CheckoutRecordEntry(cds[1], LocalDate.of(2016, 2, 15),LocalDate.of(2016, 4, 15), ItemType.CD),//16*
				new CheckoutRecordEntry(cds[2], LocalDate.of(2016, 9, 10),LocalDate.of(2015, 11, 10), ItemType.CD),//17
				new CheckoutRecordEntry(cds[1], LocalDate.of(2016, 10, 1),LocalDate.of(2016, 12, 1), ItemType.CD),//18*
				new CheckoutRecordEntry(cds[2], LocalDate.of(2017, 1, 1),LocalDate.of(2017, 3, 1), ItemType.CD),//19
				new CheckoutRecordEntry(cds[1], LocalDate.of(2017, 1, 1),LocalDate.of(2017, 3, 1), ItemType.CD),//20*
				new CheckoutRecordEntry(cds[2], LocalDate.of(2017, 3, 15),LocalDate.of(2017, 5, 11), ItemType.CD),//21
				new CheckoutRecordEntry(cds[1], LocalDate.of(2015, 1, 1),LocalDate.of(2015, 3, 1), ItemType.CD),//22*
				new CheckoutRecordEntry(cds[3], LocalDate.of(2017, 1, 8),LocalDate.of(2017, 3, 9), ItemType.CD),//23
				new CheckoutRecordEntry(cds[1], LocalDate.of(2015, 1, 1),LocalDate.of(2015, 3, 1), ItemType.CD),//24*
